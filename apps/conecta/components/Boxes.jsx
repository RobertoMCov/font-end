...
const Boxes = ({ darkMode = false }) => {
    ...
    return (
        <>
            {!md
                ? <>
                    <p className={`${darkMode ? 'text-white' : 'text-black'} text-3xl font-semibold mt-5 mb-3`}>Especialidades</p>
                    ...
                    <p className={`${darkMode ? 'text-white' : 'text-black'} text-3xl font-semibold mt-5 mb-3`}>Estudios</p>
                ...
                : <>
                    <div id='especialidades'>
                        <p className={`${darkMode ? 'text-white' : 'text-black'} text-5xl font-semibold text-center mb-10  mt-5`}>Especialidades</p>
                    ...
                    <div id='estudios'>
                        <p className={`${darkMode ? 'text-white' : 'text-black'} text-5xl font-semibold text-center mb-10  mt-5`}>Estudios</p>
