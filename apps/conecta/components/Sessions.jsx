  ...
  return (
    <div id='sesiones'>
      ...
      <Flex justify={`${md ? 'space-between' : 'center'}`} align='center' wrap>
        ...
        >
          <Meta style={{ fontSize: '18px' }} title={<span className='text-2xl'>Radiología</span>} description='Agenda tu sesión de radiología de las mejor forma' />
          <Button className='bg-[#DB71A2] text-white text-center mt-5'>Agendar</Button>
        ...
        >
          <Meta style={{ fontSize: '18px' }} title={<span className='text-2xl'>Radioterapia</span>} description='Agenda tu sesión de radioterapia de las mejor forma' />
          <Button className='bg-[#DB71A2] text-white text-center mt-5'>Agendar</Button>
